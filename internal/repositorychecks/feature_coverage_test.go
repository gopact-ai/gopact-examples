...
func TestFeatureCoverageMatrixDocumentsExpectedCapabilities(t *testing.T) {
	...
	tests := []struct {
		...
		{
			capability:  "Dev Agent self-bootstrap workflow with workspace diff, file snapshot, command, CI gate, run export, failure attribution, and verification report evidence",
