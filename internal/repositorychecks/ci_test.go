...
func TestExamplesUseCurrentReleasedModules(t *testing.T) {
	...
	for _, requirement := range []string{
		...
		"github.com/gopact-ai/gopact-ext/devagent/filesnapshot v0.1.28",
		"github.com/gopact-ai/gopact-ext/devagent/gitdiff v0.1.28",
		"github.com/gopact-ai/gopact-ext/devagent/selfbootstrap v0.1.9",
		"github.com/gopact-ai/gopact-ext/devagent/workspace v0.1.10",
		"github.com/gopact-ai/gopact-ext/models/agnes v0.1.32",
		"github.com/gopact-ai/gopact-ext/models/ark v0.2.29",
	...
	if !strings.Contains(generatedAgent, `gopactVersion = "v0.0.55"`) {
		t.Fatal("quickstart/generated-agent must exercise gopact agent init at current core SDK v0.0.55")
	}
	if !strings.Contains(generatedCluster, `gopactVersion = "v0.0.55"`) {
		t.Fatal("quickstart/generated-cluster must exercise gopact agent init-cluster at current core SDK v0.0.55")
	}
}
