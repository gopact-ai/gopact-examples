...
| `quickstart/self-bootstrap` | Dev Agent self-bootstrap workflow，覆盖 policy-approved plan patch apply、diff、file snapshot、command、CI gate、run export、failure attribution 和 verification report evidence。 | 否 |
