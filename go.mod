...
require (
	...
	github.com/gopact-ai/gopact-ext/agents/scheduler v0.1.9
	...
	github.com/gopact-ai/gopact-ext/devagent/workspace v0.1.11
	github.com/gopact-ai/gopact-ext/models/agnes v0.1.33
	github.com/gopact-ai/gopact-ext/models/ark v0.2.30
