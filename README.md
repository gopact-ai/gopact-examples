...
| `quickstart/self-bootstrap` | Dev Agent self-bootstrap workflow with workspace patch apply, diff, file snapshot, command, CI gate, run export, failure attribution, and verification report evidence. | No |
