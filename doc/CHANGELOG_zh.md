...
- 增加 `quickstart/self-bootstrap`，无凭据演示可复用 Dev Agent self-bootstrap workflow、policy-approved plan patch apply、diff、file snapshot、command、CI gate、run export 和 verification report evidence。
