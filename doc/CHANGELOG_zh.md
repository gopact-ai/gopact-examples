...
- generated agent 和 generated cluster quickstart 跟进 core `v0.0.55`，覆盖默认 module path，并验证生成 cluster 的 `GOPACT_A2A_REGISTRY_URL` bootstrap 行为。
...
- 示例仓库跟进 `gopact` core `v0.0.55` 及对应的 `gopact-ext` 发布 tag。
