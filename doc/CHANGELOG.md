...
- The generated agent and generated cluster quickstarts now use core `v0.0.49`, exercise default module paths, and cover generated cluster `GOPACT_A2A_REGISTRY_URL` bootstrap behavior.
...
- Examples now track `gopact` core `v0.0.49` and the matching `gopact-ext` release tags for that core line.
