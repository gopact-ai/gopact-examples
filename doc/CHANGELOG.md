...
- Add `quickstart/self-bootstrap` to demonstrate the reusable Dev Agent self-bootstrap workflow with policy-approved plan patch apply, diff, file snapshot, command, CI gate, run export, and verification report evidence.
