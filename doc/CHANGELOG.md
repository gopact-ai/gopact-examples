...
- Add `quickstart/self-bootstrap` to demonstrate the reusable Dev Agent self-bootstrap workflow with local workspace diff, file snapshot, command, CI gate, run export, and verification report evidence.
